...
<section>
  <div class="content">
    ...
    <div class="info">
      ...
      <p>Welcome to  <span class="movie-night">Customer Service.</span> Event Management System! We are passionate about creating seamless and unforgettable event experiences for our clients. Whether you're planning a corporate conference, a wedding, or a community gathering, our platform is designed to simplify the entire event management process.</p>
    </div>
    <div class="swiper">
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          ...
          {/* <span>8.5</span> */}
  {/* <img src="https://plus.unsplash.com/premium_photo-1661573774331-5df65d7fd43e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8ZXZlbnQlMjBwbGFubmluZ3xlbnwwfHwwfHx8MA%3D%3D"></img> */}
